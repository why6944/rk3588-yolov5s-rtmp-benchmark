...
public:
    ...
    void record_preprocess_detail(long long copy_us, long long color_us, long long resize_us);
...
private:
    ...
    std::atomic<long long> pre_copy_us_{0};
    std::atomic<long long> pre_color_us_{0};
    std::atomic<long long> pre_resize_us_{0};
